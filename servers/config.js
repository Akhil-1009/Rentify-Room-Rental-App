...
export const RAZORPAY_SECRET_ACCESS=process.env.RAZORPAY_SECRET;
export const RAZORPAY_SECRET_ACESS_KEY=process.env.RAZORPAY_SECRET_KEY;
...
export const instance = new Razorpay({
    key_id:RAZORPAY_SECRET_ACESS_KEY,
    key_secret:RAZORPAY_SECRET_ACCESS
});
